use wasm_parse::wasm::instr::{
    Block, ControlInstr, FBinop, FRelop, FUnop, FloatType, IBinop, IRelop, ITestop, IUnop, Instr,
    IntType, NumericInstr,
};
...
impl Execute for Instr {
    fn execute(&self, stack: &mut Vec<Val>, context: &Context) {
        match self {
            ...
            Instr::Control(x) => x.execute(stack, context),
...
impl Execute for ControlInstr {
    fn execute(&self, stack: &mut Vec<Val>, context: &Context) {
        match self {
            ...
            ControlInstr::Block(x) => x.execute(stack, context),
            ...
            ControlInstr::Return => unimplemented!("Instruction not implemented"),
            ControlInstr::Call(_fidx) => unimplemented!("Instruction not implemented"),
